...
<table>
	...
	<tr>
		<th colspan="2">
			<input type="button" onclick="location.href='./RequestBoardlist'" value="리스트"/>
			<input type="button" onclick="location.href='./requpdateForm?board_no=${info.board_no}'" value="수정"/>
